...
There seemed to be much less outliers. Looking at the second clustering graph, the x-axis goes from -1 to 8. It doesnt take into considering the 3 data points we had after -1 on the x-axis. In my opinion  not having to deal with the totality of the dataset and ignoring some outliers helped to have a cleaner graph.
